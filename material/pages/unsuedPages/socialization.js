...
export default class home_page extends Component {
  render() {
    return (
      <Layout>
        <h1>
          <Emoji symbol="🤼" label="socializtaion" />
          社交篇
        </h1>
        <p>
        ...
        <h2>
          <Emoji symbol="❤️❤️" label="heart" />
          后话：十几年的生命，前面几个月的社交只是很小的一部分。如果你错过了这一段时间，完全没有必要担心，因为你们在一起的时间还有很长。
        </h2>
      </Layout>
    )
  }
