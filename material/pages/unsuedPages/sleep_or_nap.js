  ...
  render() {
    return (
      <Layout>
        ...
        <h2>
          <Emoji symbol="🐩" label="poodle" />
          数千年的埃及历，一定少不了供奉我们的睡神-狗子 。 这一切都是有原因的
        </h2>
        <p>
          狗子的行为可以很出乎意料，比如突然开始玩你的鞋子，拍打你的枕头，弄你的裤脚，甚至想过来玩你了。你很纳闷，
          “什么情况？我才刚带你出去走了一小时回来呢”。难道狗狗的精力真的是无限的吗？错。这样不符合常理的情况说明你应该让你的宝贝去睡觉了。在中文里，一个词语很贴切
          - “歇斯底里”。累的要死还要硬撑，玩起来就特别凶。
        </p>
        ...
        <p>
          3个月大的幼犬每天需要15到20小时的睡眠。完全成年的狗（平均1岁半左右）每天需要12到16小时的睡眠。当然，年龄，犬种，身体健康状况等等都是影响因素。总而言之，要睡很久很久。这样你也有自己的时间去工作，学习和照顾其他家庭成员！和普通的犬种相比，工作犬（警犬，缉毒犬，救援犬）需要更少的睡眠。
        </p>

        <h2>
          <Emoji symbol="🤤" label="drooling" />
          明明很累，倒地就睡，难道不香吗？
        </h2>
        <p>
        ...
        <h2>
          <Emoji symbol="🏡" label="crate" />
          幼犬应该在哪里睡眠呢？
        </h2>
        <p>
          人没有睡好，有起床气。人缺觉，会脾气暴躁。幼犬和成年犬也有点相像。他们在缺少睡眠的时候会和人一样紧张。所以我们要给它们提供一个安全的住处。进行
          <bold>笼子训练</bold>{" "}
          -这一部分我们会在其他地方涵盖。因为笼子能够给它们提供安全，安静，阴暗，而且阴凉的环境，很适合休息。笼子其实也不一定就是要笼子，它可以只是一张狗床，一条毯子，一个小角落。重点是幼犬知道那一块区域自己打盹不会被打扰，没有小朋友的捉弄，没有空调噪音。如果你的狗能倒地就睡，恭喜你，它胸宽如大海，不要踩到它。
        </p>

        <h2>
          <Emoji symbol="༗" label="magic" />
          怎么诱导幼犬入眠呢？
        </h2>
        <p>
