...
- 0528: Emoji, Layout, GraphQL, useStaticQuery
...
- 0606 -> 0607
  - MDX = JSX + Markdown. JSX is not the best for content, Markdown is not the best for operatins. Therefore, MDX with theme might be the better option
